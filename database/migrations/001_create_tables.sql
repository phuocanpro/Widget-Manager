...
CREATE INDEX idx_widgets_chatwoot_token ON widgets(chatwoot_website_token);
CREATE INDEX idx_widgets_chatwoot_account_id ON widgets(chatwoot_account_id);
CREATE INDEX idx_widgets_chatwoot_inbox_id ON widgets(chatwoot_inbox_id);
